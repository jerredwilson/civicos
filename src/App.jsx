...
const DEMO_USERS = [
  { username: 'superadmin',          password: 'CivicOS#Demo1', role: 'Super Admin',                desc: 'Full platform access — manages all municipalities & users' },
  { username: 'mckinneycitymanager', password: 'CivicOS#Demo1', role: 'City Manager · McKinney TX', desc: 'Full admin for McKinney land-use cases & users' },
  { username: 'prospercitymanager',  password: 'CivicOS#Demo1', role: 'City Manager · Prosper TX',  desc: 'Full admin for Prosper land-use cases & users' },
  { username: 'mckinneyreadonly',    password: 'CivicOS#Demo1', role: 'Viewer · McKinney TX',       desc: 'Read-only access to McKinney cases' },
  { username: 'prosperreadonly',     password: 'CivicOS#Demo1', role: 'Viewer · Prosper TX',        desc: 'Read-only access to Prosper cases' },
]
      ...
      <div className="login-card">
        ...
        <div className="demo-users">
          <button type="button" className="demo-toggle" onClick={() => setShowDemo(s => !s)}>
            <span className="demo-chevron">{showDemo ? '▲' : '▼'}</span> Test accounts
          </button>
          {showDemo && (
              ...
              {DEMO_USERS.map(u => (
                ...
                >
                  <span className="demo-row-left">
                    <span className="demo-row-user">{u.username}</span>
                    <span className="demo-row-role">{u.role}</span>
                  </span>
                  <span className="demo-row-desc">{u.desc}</span>
                </button>
              ))}
            </div>
          )}
...
export default function App() {
  ...
  const [activePage, setActivePage]   = useState('Land & Use Planning')
